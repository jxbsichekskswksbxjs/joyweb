    ...
    <div className={styles['container']}>
      ...
      <div className={styles['Section1']}>
        <div className={styles['container01']}>
          <div className={styles['Container02']}>
            ...
            <h3
              className={` ${styles['text003']} ${projectStyles['healine']} `}
            >
              I&apos;ve risen with the soles burned
            </h3>
            <span
              className={` ${styles['text004']} ${projectStyles['textXL']} `}
            >
          ...
          <div className={styles['CardsContainer']}>
            <div className={styles['Card1']}>
              ...
              <h6
                className={` ${styles['text006']} ${projectStyles['textXL']} `}
              >
                Awarded Agency
              </h6>
            ...
            <div className={styles['Card2']}>
              ...
              <h6
                className={` ${styles['text008']} ${projectStyles['textXL']} `}
              >
                Free Revisions
              </h6>
            ...
            <div className={styles['Card3']}>
              ...
              <h6
                className={` ${styles['text010']} ${projectStyles['textXL']} `}
              >
                Verified Company
              </h6>
          ...
          <div className={styles['WorkWithUs']}>
            <div className={styles['container06']}>
              ...
              <h3
                className={` ${styles['text012']} ${projectStyles['healine']} `}
              >
              ...
              <span className={styles['text018']}>Check Notus PRO React!</span>
            </div>
            <div className={styles['container08']}>
              ...
              <div className={styles['container10']}>
                <h4
                  className={` ${styles['text019']} ${projectStyles['healine']} `}
                >
                  <span className={styles['text020']}>Top Notch Services</span>
                  <br></br>
                </h4>
      ...
      <div className={styles['Pricing']}>
        <div className={styles['container11']}>
          <div className={styles['PricingCard']}>
            <span className={styles['text023']}>Free</span>
            <div className={styles['container12']}>
              <span className={styles['text024']}>
                <span>$</span>
                <span></span>
              </span>
              <span className={styles['text027']}>0</span>
            </div>
          ...
          <div className={styles['PricingCard1']}>
            <span className={styles['text036']}>basic</span>
            <div className={styles['container14']}>
              <span className={styles['text037']}>
                <span>$</span>
                <span></span>
              </span>
              <span className={styles['text040']}>9</span>
          ...
          <div className={styles['PricingCard2']}>
            <span className={styles['text056']}>Pro</span>
            <div className={styles['container16']}>
              <span className={styles['text057']}>
                <span>$</span>
                <span></span>
              </span>
              <span className={styles['text060']}>29</span>
      ...
      <div className={styles['Section2']}>
        <div className={styles['container18']}>
          ...
          <h2 className={` ${styles['text074']} ${projectStyles['text2XL']} `}>
            <span className={styles['text075']}>
              You need to fight like David with Goliath
            </span>
            <br></br>
          </h2>
          <span className={` ${styles['text076']} ${projectStyles['textXL']} `}>
        ...
        <div className={styles['GrowingCompanySection']}>
          ...
          <div className={styles['container19']}>
            ...
            <h3
              className={` ${styles['text077']} ${projectStyles['healine']} `}
            >
              A growing company
            </h3>
            ...
            <div className={styles['container23']}>
              ...
              <span className={styles['text080']}>Amazing page examples</span>
            </div>
            <div className={styles['container25']}>
              ...
              <span className={styles['text081']}>Dynamic components</span>
            </div>
          </div>
        </div>
        <div className={styles['container27']}>
          <h6 className={styles['text082']}>
            <span>THE ENTOURAGE</span>
          </h6>
          <h3 className={` ${styles['text084']} ${projectStyles['healine']} `}>
            It is everything, and it won&apos;t change
          </h3>
          <span className={` ${styles['text085']} ${projectStyles['textXL']} `}>
      ...
      <div className={styles['Stats']}>
        <div className={styles['Stat']}>
          <h1 className={styles['text087']}>
            <span>50</span>
            <span>+</span>
          </h1>
          <span className={styles['text090']}>Happy clients</span>
          <span className={styles['text091']}>
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className={styles['Stat1']}>
          <h1 className={styles['text092']}>
            <span>369</span>
          </h1>
          <span className={styles['text094']}>Projects completed</span>
          <span className={styles['text095']}>
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className={styles['Stat2']}>
          <h1 className={styles['text096']}>
            <span>500</span>
            <span>+</span>
          </h1>
          <span className={styles['text099']}>Hours</span>
          <span className={styles['text100']}>
            Lorem ipsum dolor sit amet, consectetur adipiscing.
          </span>
        </div>
        <div className={styles['Stat3']}>
          <h1 className={styles['text101']}>
            <span>24/7</span>
          </h1>
          <span className={styles['text103']}>Support</span>
      ...
      <div className={styles['Section3']}>
        <div className={styles['container28']}>
          <h6 className={` ${styles['text105']} ${projectStyles['textSM']} `}>
            <span>ON THE COASTLINE</span>
          </h6>
          <h3 className={` ${styles['text107']} ${projectStyles['healine']} `}>
            We are missing the summer
          </h3>
          <span className={` ${styles['text108']} ${projectStyles['textXL']} `}>
          ...
          <div className={styles['Services']}>
            ...
            <div className={styles['container29']}>
              ...
              <h1
                className={` ${styles['text110']} ${projectStyles['textXL']} `}
              >
                Grow your market
              </h1>
            ...
            <div className={styles['container31']}>
              ...
              <h1
                className={` ${styles['text112']} ${projectStyles['textXL']} `}
              >
                Launch time
              </h1>
          ...
          <div className={styles['Contact']}>
            ...
            <h2 className={styles['text114']}>Type in the bellow form</h2>
            <span
              className={` ${styles['text115']} ${projectStyles['textXL']} `}
            >
            ...
            <div className={styles['Form']}>
              <h1 className={styles['text116']}>Want to work with us?</h1>
              <span
                className={` ${styles['text117']} ${projectStyles['textXL']} `}
              >
                Complete this form and we will get back to you in 24 hours.
              </span>
              <span
                className={` ${styles['text118']} ${projectStyles['textXS']} `}
              >
                FULL NAME
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text119']} ${projectStyles['textXS']} `}
              >
                EMAIL
              </span>
              <input
              ...
              />
              <span
                className={` ${styles['text120']} ${projectStyles['textXS']} `}
              >
                MESSAGE
              </span>
              <textarea
