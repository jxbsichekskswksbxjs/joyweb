    ...
    <div className={styles['container']}>
      <div className={styles['container1']}>
        ...
        <div className={styles['container2']}>
          <span className={` ${styles['text']} ${projectStyles['textLG']} `}>
            {props.name}
          </span>
          <span className={` ${styles['text1']} ${projectStyles['textMD']} `}>
            {props.text}
          </span>
          <div className={styles['container3']}>
            ...
            <span className={` ${styles['text4']} ${projectStyles['textXS']} `}>
              {props.shares}
            </span>
            <span className={` ${styles['text5']} ${projectStyles['textXS']} `}>
              shares
            </span>
          </div>
        </div>
